...
import { FaThumbsUp, FaSadCry } from 'react-icons/fa';
                    ...
                    <span>
                            ...
                            <span>
                                ...
                                <p onMouseEnter={() => this.handleMouseHover(post.id)}
                                    ...
                                    onClick={() => this.handelLike(post.id)}
                                    style={{color:(post.likes.items.length > 0) ? "red": "gray"}}
                                ...
                                </p>
                                {
                                    ...
                                    <div className="users-liked">
                                        ...
                                        {
                                            this.state.postLikedBy.length === 0 ? <FaSadCry/> : 
